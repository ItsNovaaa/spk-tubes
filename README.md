...
with `python web_app/app.py` command 

we use flask for the backend (calculation and endpoint) and tailwind for styling the web (cdn)

Framework Documentation (Web) : 
